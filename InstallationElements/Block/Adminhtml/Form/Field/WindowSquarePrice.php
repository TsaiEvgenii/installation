...
class WindowSquarePrice extends AbstractFieldArray
{
    ...
    protected function _prepareToRender(): void
    {
        ...
        $this->addColumn('window_sqr_sku_prefix', [
            'label' => __('SKU Prefix'),
            'class' => 'required-entry',
            'renderer' => $this->getTextAreaRenderer()
        ]);
        $this->addColumn('window_sqr_from_sqr', [
            'label' => __('From sqr'),
            'class' => 'required-entry validate-number validate-zero-or-greater'
        ]);
        $this->addColumn('window_sqr_to_sqr', [
            'label' => __('To sqr'),
            'class' => 'required-entry validate-number validate-zero-or-greater'
        ]);
        $this->addColumn('window_sqr_price', [
            'label' => __('Price'),
            'class' => 'required-entry validate-number validate-zero-or-greater'
        ]);
