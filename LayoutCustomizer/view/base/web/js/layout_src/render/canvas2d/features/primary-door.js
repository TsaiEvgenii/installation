define([
    ...
    class PrimaryDoorDrawer extends FeatureDrawer.Base {
        constructor() {
            super();
            this._image = null;
        }
        ...
        _draw(drawer, feature) {
            if (!feature.params.is_primary) return;
        ...
        _getImage(drawer, width, height) {
            let image = false,
                url = drawer.getAssetUrl('primary-door-image');
            if (url) {
    ...
    return {Drawer: PrimaryDoorDrawer};
});
