...
class GetInColorServiceTest extends TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    public function getData()
    {
        return [
            ...
            'result-in-color-inside'=>[
                'selectedOptions'=>[],
                'options'=>[$this->createMockOption(['inside_outside_color'=>'inside'], ['getValues'=> [$this->createMockValue(['title'=>'Title value 1', 'is_default'=>true], ['getId'=>1])
                                ]])],
                'with'=>['data'=>[ColorDescriptionInterface::COLOR_TYPE=>'inside',
                         ColorDescriptionInterface::IS_DEFAULT=>true,
                         ColorDescriptionInterface::TITLE => 'Title value 1']],
                'result'=> new ColorDescription([ColorDescriptionInterface::COLOR_TYPE=>'inside',
                                                 ColorDescriptionInterface::IS_DEFAULT=>true,
                                                 ColorDescriptionInterface::TITLE => 'Title value 1'])
            ],
            'result-in-color-inside-2'=>[
                'selectedOptions'=>[],
    ...
    protected function setUp(): void
    {
        ...
        $this->objectFactory  = $this->getMockBuilder(ObjectFactory::class)
                        ...
                        ->getMock();
        $this->model = new GetInColorService($this->objectFactory);
    }
